...
namespace PX.Objects.GL
{
    ...
    {
        public const string PurchaseReceipt = "PO302000";
        public const string Shipment        = "SO302000";
        ...
        protected void _(Events.RowPersisted<Batch> e)
        {
            ...
            if (e.Operation != PXDBOperation.Delete && e.Row.Status == BatchStatus.Unposted && string.IsNullOrEmpty(e.Row.Description) )
            {
