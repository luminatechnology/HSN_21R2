...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	<px:PXGrid AllowSearch="True" FastFilterFields="SettlementNbr,BatchNbr,AccountID,SubID,RefNbr,TranDesc,InventoryID,ProjectID,TaskID,CostCodeID" AdjustPageSize="Auto" SyncPosition="True" ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="PrimaryInquire" AllowAutoHide="false">
		<Levels>
